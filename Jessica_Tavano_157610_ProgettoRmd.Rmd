...
# - un comune ha PageRank alto se riceve pendolari da molti comuni importanti, ed è collegato a un circuito di mobilità centrale nella rete
...
plot_graph_region_map <- function(nome_reg, soglia, top_n) {
  ...
  # PageRank: i nodi che attraggono flussi importanti diventano centrali nella rete
